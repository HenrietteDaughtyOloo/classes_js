...
const vehicle = new Car('BMW', 'X3 Series', 2022, false);
vehicle.toggleAvailability();
console.log(vehicle.isAvailable);  // changes THE AVAILABILITY INTO FALSE 

vehicle.toggleAvailability();   // changes to THE AVAILABILITY INTO TRUE 
...
console.log(renting1.calculateDuration());
...
const question1 = new Question(
    "Africa is a country.", ["True", "False"], "False"
);
console.log(question1.answerCheck("True"));
console.log(question1.answerCheck("False"));
...
class Quiz extends Question{
    ...
    questionAdd(questionObject){
        return questionObject += this.questions;
    }
    questionAdd(){
        this.currentQuestionIndex++;
    }
    answerSubmit(userAnswer1){
        return userAnswer === this.correctAnswer;
    }
}
